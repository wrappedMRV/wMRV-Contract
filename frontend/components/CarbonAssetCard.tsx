...
const ChainInfo: React.FC<{ chainName: string; tokenCount: string }> = ({
  ...
  <div className="flex items-center mb-4">
    <img
      src="https://cdn.builder.io/api/v1/image/assets/TEMP/92506c386274628b1d4bcf22e27eb7c3397b753eb30ecd9a8bda0109eb1d0b37?apiKey=e3802405984e420cb725bf0a04130d05&"
      alt="Chain logo"
...
const CarbonAssetCard: React.FC<CarbonAssetCardProps>= ({attributes}) => (
  ...
  <div className="bg-[#141414] rounded-xl p-6 w-3/4  mx-auto">
    ...
    <div className="block">
      <TokenRow
        name="Wrapped Toucan CO2 Tokens"
        balance="100 MATIC"
        change="+5%"
        imgUrl="https://cdn.builder.io/api/v1/image/assets/TEMP/12c466e3bc1b55d52ea2c0802f192fbf266b8301d7ac4b5f116ddd63d4653b2b?apiKey=e3802405984e420cb725bf0a04130d05&width=100 100w"
      />
      <TokenRow
        name="Toucan CO2 Tokens"
        balance="100 MATIC"
        change="-3%"
        imgUrl="https://cdn.builder.io/api/v1/image/assets/TEMP/7c373d914e9f2d37913e06f3b6f880323f6ee5381090037c372bdbb0425c4d21?apiKey=e3802405984e420cb725bf0a04130d05&width=100 100w"
      />
    </div>
