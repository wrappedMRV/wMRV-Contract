      ...
      <div className="flex gap-5 items-start py-4">
        <div className="items-stretch flex gap-2">
          <div className="text-white text-sm leading-6 grow whitespace-nowrap">
            <span className="px-2">
              <input type="checkbox" className="w-5 p-2 checked:bg-blue-500" />
            </span>{" "}
            Select All
          </div>
        </div>
        <div className="items-stretch self-stretch flex justify-between gap-2">
          <button className="items-stretch rounded border bg-green-300  bg-opacity-[10%] flex  flex-col justify-center px-2 py-1 border-solid border-zinc-500 text-white">
            Wrap
          </button>
          <button className="items-stretch rounded border bg-rose-800  bg-opacity-[10%] flex  flex-col justify-center px-2 py-1 border-solid border-zinc-500 text-rose-800">
            Retire All
          </button>
        </div>
      </div>
