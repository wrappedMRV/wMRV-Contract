  ...
  const SelectElem: React.FC<SelectElemProps> = ({   
    ...
    return (
        ...
        <div className="flex flex-col pt-4 px-4 items-start  w-full">
          <div className="flex gap-5 items-start">
            <div className="items-stretch flex gap-2">
              <div className="text-white text-sm leading-6 grow whitespace-nowrap">
               <span className="px-2"><input type="checkbox"  className="w-4 h-4 p-2 checked:bg-blue-500" /></span> Select All
              </div>
            </div>
          ...
          <div className="items-start self-stretch flex gap-0 mt-1 border-b-violet-200 border-b-opacity-10 border-b border-solid max-md:max-w-full max-md:flex-wrap max-md:justify-center">
