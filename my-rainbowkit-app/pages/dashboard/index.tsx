...
<div className="mx-auto py-10 ">
      ...
      <CustomHeader title="Pending TCO2 Wrappers" className="text-lg leading-7 mt-14 p-5" />
      <div className="items-stretch bg-neutral-900 flex flex-col mt-8 p-6 rounded-2xl w-3/4 mx-auto">
        <div className="items-center bg-gray-900 flex flex-col px-4 py-7 rounded-xl">
          ...
          />
          <CustomHeader title="You have no pending TCO2 Wrappers" className="text-2xl font-bold leading-9 mt-4" />
      ...
      <CustomHeader title="Retired Carbon Credits" className="text-lg leading-7 mt-14 p-5" />
