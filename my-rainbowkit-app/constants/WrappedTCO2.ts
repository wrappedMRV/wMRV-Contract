export const wrappedTCO02Abi = [
  ...
  {
    inputs: [],
    name: "oracleUrlSource",
    outputs: [
      {
        internalType: "contract IOracleUrlSource",
        name: "",
        type: "address",
      },
    ],
  ...
  },
  {
    ...
    outputs: [
      {
        internalType: "contract IToucanCarbonOffsetsBase",
        name: "",
        type: "address",
      },
    ],
